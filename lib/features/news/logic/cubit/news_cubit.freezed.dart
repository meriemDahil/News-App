...
class _$SuccessImpl implements Success {
  const _$SuccessImpl(final List<Article> articles) : _articles = articles;
  ...
  @override
  String toString() {
    return 'NewsState.success(articles: $articles)';
  }
...
abstract class Success implements NewsState {
  const factory Success(final List<Article> articles) = _$SuccessImpl;
