...
abstract class _NewsResponse implements NewsResponse {
  factory _NewsResponse(
      ...
      required final List<Article> articles}) = _$NewsResponseImpl;
...
class _$SourceImpl implements _Source {
  _$SourceImpl({this.id, required this.name});
...
abstract class _Source implements Source {
  factory _Source({final String? id, required final String name}) =
      _$SourceImpl;
